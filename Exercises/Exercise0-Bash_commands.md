...
c) Print out the “current path is: <your current directory path></your>” in bash
...
| curl    | Transfer data from or to a server using various protocols like HTTP, HTTPS, FPT, and more                                                                                                   |                     |
| sudo    | Run any Bash command as a substitute user                                                                                                                                                   |                     |
| apt-get | Install, update, upgrade and remove software packages easily by fetching them from configured repositories                                                                                  |                     |
| ps      | Display information about active processes                                                                                                                                                  |                     |
| cp      | Copy files and directories                                                                                                                                                                  |                     |
| less    | View the contents of a file one page at a time without opening it in an editor.                                                                                                             |                     |
| top     | Display and manage the top process                                                                                                                                                          |                     |
| head    | Display the first part of a file to understand its structure                                                                                                                                |                     |
| echo    | Show a line of text or a variable's value in the terminal                                                                                                                                   |                     |
...
| wget    | Download files from the web (single files, entire websites, or even batch downloads)                                                                                                        |                     |
| pwd     | Print the current working directory                                                                                                                                                         |                     |
| >>      | Append output to a file                                                                                                                                                                     |                     |
| >       | Write/overwrite file                                                                                                                                                                        |                     |
| \*      | (* is a wildcard (also called glob)) Match any number of characters in a filename                                                                                                           |                     |
| ./      | Run a program or script that is located in your current directory                                                                                                                           |                     |
| diff    | Compare the contents of two files and display the differences between them                                                                                                                  |                     |
| find    | Search for files and directories based on name, type, size, date, or other conditions. It scans the specified directory and its sub directories to locate files matching the given criteria |                     |
